...
var _STAR_print_newline_STAR__orig_val__29435_29525 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__29436_29526 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__29437_29527 = true;
var _STAR_print_fn_STAR__temp_val__29438_29528 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__29437_29527);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__29438_29528);

try{var _STAR_print_level_STAR__orig_val__29439_29529 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__29440_29530 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29440_29530);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29439_29529);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__29436_29526);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__29435_29525);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq29430){
...
var new_formatters = current_formatters.filter((function (p1__29484_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__29484_SHARP_)));
}));
...
var G__29489_29546 = f;
var target__27542__auto___29547 = G__29489_29546;
if(cljs.core.truth_(target__27542__auto___29547)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29489_29546)].join(''),"\n","target__27542__auto__"].join('')));
}

(target__27542__auto___29547["toString"] = (function (){
...
var G__29493_29550 = "%c%s";
var G__29494_29551 = "color:transparent";
var G__29495_29552 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__29493_29550,G__29494_29551,G__29495_29552) : f.call(null,G__29493_29550,G__29494_29551,G__29495_29552));
...
while(true){
if((i__4737__auto___29558 < len__4736__auto___29556)){
...
var vec__29501 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29501,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29501,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__29564__delegate = function (add_fmt,add_args){
...
var G__29564 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__29565__i = 0, G__29565__a = new Array(arguments.length -  1);
while (G__29565__i < G__29565__a.length) {G__29565__a[G__29565__i] = arguments[G__29565__i + 1]; ++G__29565__i;}
  add_args = new cljs.core.IndexedSeq(G__29565__a,0,null);
} 
return G__29564__delegate.call(this,add_fmt,add_args);};
G__29564.cljs$lang$maxFixedArity = 1;
G__29564.cljs$lang$applyTo = (function (arglist__29566){
var add_fmt = cljs.core.first(arglist__29566);
var add_args = cljs.core.rest(arglist__29566);
return G__29564__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq29496){
...
var G__29499 = cljs.core.first(seq29496__$2);
var seq29496__$3 = cljs.core.next(seq29496__$2);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29497,G__29498,G__29499,seq29496__$3);
}));
...
var seq__29511 = cljs.core.seq(features);
var chunk__29512 = null;
var count__29513 = (0);
var i__29514 = (0);
while(true){
if((i__29514 < count__29513)){
var feature = chunk__29512.cljs$core$IIndexed$_nth$arity$2(null,i__29514);
...
var G__29568 = seq__29511;
var G__29569 = chunk__29512;
var G__29570 = count__29513;
var G__29571 = (i__29514 + (1));
seq__29511 = G__29568;
chunk__29512 = G__29569;
count__29513 = G__29570;
i__29514 = G__29571;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__29511);
if(temp__5735__auto__){
var seq__29511__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__29511__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__29511__$1);
var G__29572 = cljs.core.chunk_rest(seq__29511__$1);
var G__29573 = c__4556__auto__;
var G__29574 = cljs.core.count(c__4556__auto__);
var G__29575 = (0);
seq__29511 = G__29572;
chunk__29512 = G__29573;
count__29513 = G__29574;
i__29514 = G__29575;
continue;
} else {
var feature = cljs.core.first(seq__29511__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__29576 = cljs.core.next(seq__29511__$1);
var G__29577 = null;
var G__29578 = (0);
var G__29579 = (0);
seq__29511 = G__29576;
chunk__29512 = G__29577;
count__29513 = G__29578;
i__29514 = G__29579;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5733__auto__)){
var o29519 = temp__5733__auto__;
return (o29519["version"]);
} else {
return null;
}
})() == null);

...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28198){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28199,G__28200,seq28198__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28240_SHARP_){
return (!((cljs.core.meta(p1__28240_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28272__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e28280){var _e__27561__auto__ = e28280;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e28284){var _e__27561__auto__ = e28284;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28291 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28292 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28292);

try{var map__28298 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28298__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28291);
}});
...
var temp__5733__auto___28338 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___28338)){
var managed_print_level_28339 = temp__5733__auto___28338;
var _STAR_print_level_STAR__orig_val__28303_28340 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28304_28341 = managed_print_level_28339;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28304_28341);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__28300_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__28300_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28303_28340);
}} else {
job_fn();
}

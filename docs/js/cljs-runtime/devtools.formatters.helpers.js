...
var G__28197 = devtools.prefs.pref(v);
v = G__28197;
continue;
} else {
return v;
...
}catch (e28168){var _e__27561__auto__ = e28168;
return false;
}})();
...
}catch (e28172){var _e__27561__auto__ = e28172;
return false;
}})();
...
}catch (e28174){var _e__27561__auto__ = e28174;
return false;
}}
}
});
...
var vec__28184 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28184,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28184,(1),null);
...
return cljs.core.some((function (p1__28191_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28191_SHARP_);
}),template);
});

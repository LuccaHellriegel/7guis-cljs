...
}catch (e30249){var _e__27561__auto__ = e30249;
return false;
...
}catch (e30252){var _e__27561__auto__ = e30252;
return false;
...
}catch (e30272){var _e__27561__auto__ = e30272;
return false;
...
}catch (e30274){var _e__27561__auto__ = e30274;
return false;
...
}catch (e30288){var _e__27561__auto__ = e30288;
return false;
}})())){
...
}catch (e30311){var _e__27561__auto__ = e30311;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__30333 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__30334 = (function (){var or__4126__auto__ = config;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__30334);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__30333);
}});
});
...
return (function() { 
var G__30374__delegate = function (args){
...
while (G__30375__i < G__30375__a.length) {G__30375__a[G__30375__i] = arguments[G__30375__i + 0]; ++G__30375__i;}
  args = new cljs.core.IndexedSeq(G__30375__a,0,null);
} 
return G__30374__delegate.call(this,args);};
G__30374.cljs$lang$maxFixedArity = 0;
G__30374.cljs$lang$applyTo = (function (arglist__30376){
var args = cljs.core.seq(arglist__30376);
return G__30374__delegate(args);
});

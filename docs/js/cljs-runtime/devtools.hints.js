...
}catch (e27885){var _e = e27885;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___27937 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___27937)){
var seen_errors_27938 = temp__5733__auto___27937;
if(cljs.core.truth_(seen_errors_27938.has(self))){
} else {
seen_errors_27938.add(self);

var temp__5735__auto___27939 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___27939)){
var sense_27940 = temp__5735__auto___27939;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_27940)].join(''));
} else {
}
}
} else {

...
var i_32891 = (0);
while(true){
if((i_32891 < arr.length)){
(arr[i_32891] = null);

var G__32892 = (i_32891 + (1));
i_32891 = G__32892;
continue;
} else {
}
...
var i_32910 = (self__.level + (1));
while(true){
if((i_32910 <= (new_level + (1)))){
(update[i_32910] = self__.header);

var G__32913 = (i_32910 + (1));
i_32910 = G__32913;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_32916 = (update[i]).forward;
(x__$2.forward[i] = (links_32916[i]));
...
var links_32922 = (update[i_32919]).forward;
if((x__$1 === (((i_32919 < links_32922.length))?(links_32922[i_32919]):null))){
(links_32922[i_32919] = (x__$1.forward[i_32919]));

var G__32924 = (i_32919 + (1));
i_32919 = G__32924;
continue;
} else {
var G__32925 = (i_32919 + (1));
i_32919 = G__32925;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__32945 = nx;
var G__32946 = (level__$1 - (1));
x = G__32945;
level__$1 = G__32946;
continue;
} else {
var G__32947 = x;
var G__32948 = (level__$1 - (1));
x = G__32947;
level__$1 = G__32948;
continue;
}

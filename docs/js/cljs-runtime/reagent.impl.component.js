...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38588 = c;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38590 = c;
...
var or__4126__auto__ = (function (){var G__38599 = c;
var G__38599__$1 = (((G__38599 == null))?null:G__38599.constructor);
if((G__38599__$1 == null)){
return null;
} else {
return G__38599__$1.displayName;
}
})();
...
var G__38600 = c;
var G__38600__$1 = (((G__38600 == null))?null:G__38600.constructor);
if((G__38600__$1 == null)){
return null;
} else {
return G__38600__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__38601 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38602 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38602);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38601);
}});
...
var c = this;
var G__38612_38704 = goog.object.get(c,"cljsRatom");
if((G__38612_38704 == null)){
} else {
reagent.ratom.dispose_BANG_(G__38612_38704);
}
...
var renders_38705 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_38706 = cljs.core.first(cljs.core.vals(renders_38705));
...
if((cljs.core.count(renders_38705) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_38705))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_38706)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_38706], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__38641 = o;
goog.object.set(G__38641,cljs.core.name(k),v);
...
while (G__38710__i < G__38710__a.length) {G__38710__a[G__38710__i] = arguments[G__38710__i + 0]; ++G__38710__i;}
  args = new cljs.core.IndexedSeq(G__38710__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__38680 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38681 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38681);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38680);
}});
...
var vec__38686 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38686,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38686,(1),null);
...
var G__38689 = goog.object.get(reagent_state,"cljsRatom");
if((G__38689 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__38689);
}
});
}),[]);

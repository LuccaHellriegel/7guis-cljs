...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_31084 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_31084(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_31087 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_31087(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_31089 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_31089(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_31090 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_31090(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_31091 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_31091(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_31102 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_31102(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_31103 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_31103(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_31104 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_31104(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_31105 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_31105(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_31106 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_31106(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_31107 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_31107(b);
}
});

...
var o27882 = temp__5733__auto__;
var temp__5733__auto____$1 = (o27882["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o27883 = temp__5733__auto____$1;
return (o27883["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
}catch (e27900){var __28159 = e27900;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27924 = num_code;
switch (G__27924) {
case (1):
return (185);
...
}catch (e27941){var _e__27561__auto__ = e27941;
return false;
}})())){
...
var vec__27947 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27947,(0),null);
...
while(true){
if((i__4737__auto___28180 < len__4736__auto___28176)){
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27993){
var vec__27994 = p__27993;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27994,(0),null);
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27991){
...
var vec__28017 = cljs.core.split_with((function (p1__28016_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28016_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28017,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28017,(1),null);
...
var vec__28034 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28034,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28034,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28192 = cljs.core.rest(remaining_tokens);
var G__28193 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28192;
name_tokens = G__28193;
continue;
} else {
...
var vec__28041 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28041,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28041,(1),null);
var vec__28044 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28044,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28044,(1),null);
var vec__28047 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28047,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28047,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28047,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28047,(3),null);
...
var vec__28059 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28059,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28059,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28059,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28059,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28059,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28059,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__28065 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28065,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28065,(1),null);
var vec__28069 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28069,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28069,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28077 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28077) : devtools.munging.parse_fn_info_deep.call(null,G__28077));
})()));
}
} else {
return fn_info;
...
var G__28201 = (arity + (1));
var G__28202 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28086){
var vec__28088 = p__28086;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28088,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28088,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28097_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28097_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28098_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28098_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28104){
var vec__28105 = p__28104;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28105,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28101){
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28120__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28120__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28120__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28120__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28121 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28121,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28121,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28121,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28121,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28121,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28121,(5),null);
...
}catch (e28126){var _e__27561__auto__ = e28126;
...
var G__28249 = (obj[cljs.core.first(path)]);
var G__28250 = cljs.core.rest(path);
obj = G__28249;
path = G__28250;
continue;
} else {
...
var _STAR_ = (function (accum,p__28135){
var vec__28136 = p__28135;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28136,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28136,(1),null);
...
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28142,(2),null);
...
var post_process = (function (p__28152){
var vec__28153 = p__28152;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28153,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28153,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28151_SHARP_){
return (obj[cljs.core.first(p1__28151_SHARP_)]);
}),sorted_matches);
